...
const cloud = freeze({
  ...
  variants: {
    sunrise: variant({
      ...
      events: fixedEvents(false, false),
      visuals: {
        fogColor: '#f0c7a4', fogDensity: 0.006, skyColor: '#7a8fd0', groundColor: '#7e9a6a',
        hemisphereIntensity: 1.3, sunColor: '#ffc98a', sunIntensity: 2.6, exposure: 1.02, skyPhase: 0.62,
        sunDisc: 1, sunElevation: 0.11, sunAzimuth: 0.4, cloudSharpness: 0.7,
        horizonGlow: 0.85, horizonGlowColor: '#ffab63',
      },
