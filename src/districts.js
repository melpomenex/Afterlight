...
export function buildDistrict(def, completed = false) {
  ...
  if (def.id === 'canal') {
    // A blocked canal is crossed by a wide, collision-free bridge at z=0.
    ...
    // Open-front greenhouse: glass ribs, planting beds, and a visible nursery.
    ...
    // Tram tracks and a weathered carriage frame the station platform.
