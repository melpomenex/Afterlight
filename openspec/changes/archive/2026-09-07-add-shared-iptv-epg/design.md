...
Reference test asset (not shipped, not fetched by code): `/home/kubuntu/Code/iptv/out/guide.epg` — XMLTV, 36 MB plain / 4.6 MB gzipped, 12,246 channels, 56,132 programmes; channel ids like `ToloTV.af` match the `tvg-id`s in the sibling `master.m3u8` (3.1 MB, ~10k channels). The repo's `english-master.m3u8` is 1.2 MB.
